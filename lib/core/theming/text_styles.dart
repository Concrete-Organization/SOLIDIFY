...
class TextStyles {
  ...
  static TextStyle font18MainBlueSemiBold = GoogleFonts.poppins(
    fontSize: 18.sp,
    color: ColorsManager.mainBlue,
    fontWeight: FontWeightHelper.semiBold,
  );
  ...
  static TextStyle font20MainBlueBold = GoogleFonts.poppins(
    fontSize: 20.sp,
    color: ColorsManager.mainBlue,
    fontWeight: FontWeightHelper.bold,
  );
  ...
  static TextStyle font18MainSemiBold = GoogleFonts.poppins(
    fontSize: 18.sp,
    color: ColorsManager.mainBlue,
    fontWeight: FontWeightHelper.semiBold,
  );
  ...
  static TextStyle font12secondaryGoldMedium = GoogleFonts.poppins(
    fontSize: 12.sp,
    color: ColorsManager.secondaryGold,
    fontWeight: FontWeightHelper.medium,
  );
  ...
  static TextStyle font14lightBlackLight = GoogleFonts.poppins(
    fontSize: 14.sp,
    color: ColorsManager.lightBlack,
    fontWeight: FontWeightHelper.light,
  );
  ...
  static TextStyle font16lightBlackRegular = GoogleFonts.poppins(
    fontSize: 16.sp,
    color: ColorsManager.lightBlack,
    fontWeight: FontWeightHelper.regular,
  );
  static TextStyle font13lightBlackRegular = GoogleFonts.poppins(
    fontSize: 13.sp,
    color: ColorsManager.lightBlack,
    fontWeight: FontWeightHelper.regular,
  );
  static TextStyle font15lightBlackRegularWith70Opacity = GoogleFonts.poppins(
    fontSize: 15.sp,
    color: ColorsManager.lightBlack.withValues(alpha: 0.70),
    fontWeight: FontWeightHelper.regular,
  );
