...
part of 'post_review_state.dart';
...
mixin _$PostReviewState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(PostReviewResponseModel response) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(PostReviewResponseModel response)? success,
...
class _$PostReviewStateCopyWithImpl<$Res, $Val extends PostReviewState>
  ...
  /// Create a copy of PostReviewState
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({PostReviewResponseModel response});
}
...
class _$SuccessImpl implements _Success {
  ...
  @override
  final PostReviewResponseModel response;

  @override
  String toString() {
    return 'PostReviewState.success(response: $response)';
  }
...
abstract class _Success implements PostReviewState {
  const factory _Success({required final PostReviewResponseModel response}) =
      _$SuccessImpl;

  PostReviewResponseModel get response;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'PostReviewState.error(error: $error)';
  }
